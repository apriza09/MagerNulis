...
<html lang="en">
  <head>
    ...
    <title>Mager Nulis | Bot Nulis</title>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href=""><h3><b style="font-family: sans-serif;">Mager Nulis</b></h3></a>
...
<section id="home" style="padding-top: 5rem;">
  ...
  <h1 class="text-center fg">Mager Nulis</h1>
  <p><h5 class="text-center fg">Mager Nulis Adalah Tool'S Bot Nulis Online Otomatis Yang Dapat Di Gunakan Ketika Anda Sedang Malas Menulis Secara Offline.</h5></p>
...
<footer class="footer mt-auto py-3 bg-warning">
  <div class="container">
    <p class="text-center text-white fg mt-3">Made With <i class="bi bi-heart-fill text-danger"></i>&nbsp;By&nbsp; <b><a href="https://github.com/apriza09" class="link-sos pl-3" style="text-decoration: none;">Hads</a></b></p>
  </div>
</footer>
<!-- Ini Akhir Footer-->
